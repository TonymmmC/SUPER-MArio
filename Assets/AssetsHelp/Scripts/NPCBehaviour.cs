...
public class NPCBehaviour : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if ((avoidsFalling && rb2d.linearVelocity.y == 0 && !FloorCast()) || (ForwardCast())) horizontalSpeed *= -1f;
    ...
    {
        if (!dead) rb2d.linearVelocity = new Vector2(horizontalSpeed, rb2d.linearVelocity.y);
    }
